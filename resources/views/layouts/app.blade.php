...
@include('layouts.kecamatan.navbar')
@include('layouts.kecamatan.sidebar')
@yield('content')

@elseif (auth()->user()->role=='Kelurahan')
@include('layouts.kelurahan.navbar')
@include('layouts.kelurahan.sidebar')
@yield('content')
